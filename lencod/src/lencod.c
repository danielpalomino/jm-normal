...
int main(int argc, char **argv) {
    ...
    originalBlocks = fopen("../filesCoderNormal/originalBlocks.txt","w");
    predictedI4MB = fopen("../filesCoderNormal/predictedI4MB.txt","w");
    ...
    fclose(originalBlocks);
    fclose(predictedI4MB);
