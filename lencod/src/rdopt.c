...
void init_rdopt(Slice *currSlice) {
    ...
    currSlice->rdcost_for_4x4_intra_blocks = (p_Vid->yuv_format == YUV444) ? rdcost_for_4x4_intra_blocks_444 : SATDcost_for_4x4_intra_blocks;
 ...
 *************************************************************************************
 */
distblk SATDcost_for_4x4_intra_blocks(Macroblock *currMB,
        int* nonzero,
        int b8,
        int b4,
        int ipmode,
...
*/
    ...
    distortion += compute_SATD4x4(currMB, PLANE_Y, block_x, block_y);
    return distortion;
